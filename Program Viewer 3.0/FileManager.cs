...
namespace Program_Viewer_3
{
    public class FileManager
    {
        ...
        /// Move folder method
        /// </summary>
        /// <param name="sourceFolder">path of source folder</param>
        /// <param name="targetFolder">path of target folder</param>
        public static string MoveFolder(string sourceFolder, string targetFolder)
        {
            targetFolder = Path.Combine(targetFolder, Path.GetFileName(sourceFolder));
            try
            {
        ...
        {
            return SendToRecycle(path, FileOperationFlags.FOF_NOCONFIRMATION | FileOperationFlags.FOF_SILENT | FileOperationFlags.FOF_WANTNUKEWARNING);
        }
